        ...
        {filteredFacilities.map((fac) => (
          ...
          >
            ...
            <div className="px-5 py-3.5 border-t border-slate-100 bg-slate-50/50 flex items-center justify-between">
              <span className="text-xs text-slate-600 font-mono font-medium">ID: {fac.id}</span>
              <div className="flex items-center gap-2">
                <button
                  type="button"
                  onClick={() => handleOpenEdit(fac)}
                  className="min-h-[36px] sm:min-h-[38px] h-[36px] sm:h-[38px] px-3.5 sm:px-4 rounded-xl border border-slate-200 text-slate-800 hover:text-slate-950 hover:bg-white text-xs sm:text-sm font-semibold transition-colors flex items-center gap-1.5 cursor-pointer shadow-xs"
                >
                ...
                <button
                  ...
                  className="min-h-[36px] sm:min-h-[38px] h-[36px] sm:h-[38px] px-3.5 sm:px-4 rounded-xl border border-rose-200 text-rose-700 hover:bg-rose-50 text-xs sm:text-sm font-semibold transition-colors flex items-center gap-1.5 cursor-pointer shadow-xs"
                >
