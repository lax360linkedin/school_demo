    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <Link
          ...
          target="_blank"
          rel="noreferrer"
          className="min-h-[44px] h-[44px] px-4 rounded-xl border border-slate-200 bg-white text-sm font-semibold text-slate-800 hover:text-slate-950 hover:bg-slate-50 transition-colors flex items-center gap-2 shadow-xs self-start sm:self-auto cursor-pointer"
        >
          ...
          >
            <div className="space-y-2 flex-1 min-w-0">
              <div className="flex flex-wrap items-center gap-2.5">
                ...
                <span className="px-2.5 py-0.5 rounded-full bg-amber-50 text-amber-900 text-xs font-bold border border-amber-200/60">
                  {sec.badge}
                </span>
                <span className="text-xs font-mono text-slate-600 font-medium">Section: #{sec.id}</span>
                <span
              ...
              <div>
                ...
                <p className="text-sm font-semibold text-amber-900 mt-0.5">{sec.subtitle}</p>
              </div>
            ...
            <div className="flex items-center md:flex-col gap-2 shrink-0 border-t md:border-t-0 md:border-l border-slate-100 pt-3 md:pt-0 md:pl-6 justify-end">
              <button
                ...
                className="min-h-[38px] h-[38px] px-4 rounded-xl bg-slate-900 hover:bg-slate-800 text-white text-xs sm:text-sm font-semibold flex items-center gap-2 w-full justify-center transition-colors shadow-xs cursor-pointer"
              >
              ...
              <Link
                ...
                target="_blank"
                rel="noreferrer"
                className="min-h-[38px] h-[38px] px-4 rounded-xl border border-slate-200 text-slate-800 hover:text-slate-950 hover:bg-slate-50 text-xs sm:text-sm font-semibold flex items-center gap-2 w-full justify-center transition-colors shadow-xs cursor-pointer"
              >
