    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-2 border-b border-[#EAE3D7]">
        ...
        <div className="flex items-center gap-3">
          ...
          <button
            ...
            className="min-h-[44px] h-[44px] px-5 rounded-xl text-sm font-semibold text-white bg-slate-900 hover:bg-slate-800 transition-colors shadow-xs cursor-pointer inline-flex items-center gap-2"
          >
      ...
      <div className="bg-white p-4 rounded-2xl border border-[#EAE3D7] shadow-2xs space-y-3 sm:space-y-0 sm:flex sm:items-center sm:justify-between gap-4">
        ...
        <div className="flex flex-wrap items-center gap-3">
          ...
          {/* Department Filter */}
          <div className="flex items-center gap-1.5">
            <span className="text-xs font-bold text-slate-700 uppercase tracking-wider">Department:</span>
            <select
                      ...
                      <td className="px-5 py-4 align-middle text-right whitespace-nowrap">
                        <div className="flex items-center justify-end gap-2">
                          ...
                          <button
                            ...
                            className="min-h-[34px] h-[34px] w-[34px] flex items-center justify-center rounded-lg border border-slate-200 text-slate-700 hover:text-slate-950 hover:bg-slate-100 transition-colors cursor-pointer shadow-xs"
                            title="Edit position"
                          >
                          ...
                          <button
                            ...
                            className="min-h-[34px] h-[34px] w-[34px] flex items-center justify-center rounded-lg border border-rose-200 text-rose-700 hover:bg-rose-50 transition-colors cursor-pointer shadow-xs"
      ...
      >
        <form onSubmit={handleSaveJob} className="space-y-4">
          ...
          <div className="pt-4 border-t border-slate-100 flex items-center justify-end gap-3">
            ...
            <button
              type="submit"
              className="min-h-[44px] h-[44px] px-5 rounded-xl text-sm font-semibold text-white bg-slate-900 hover:bg-slate-800 transition-colors shadow-xs cursor-pointer"
            >
        ...
        <div className="space-y-4">
          ...
          <div className="flex items-center justify-end gap-3 pt-2">
            ...
            <button
              ...
              className="min-h-[40px] h-[40px] px-4 rounded-xl text-sm font-semibold text-white bg-rose-600 hover:bg-rose-700 transition-colors shadow-xs cursor-pointer"
            >
              Confirm Delete
            </button>
          </div>
