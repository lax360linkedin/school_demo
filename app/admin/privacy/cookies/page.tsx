    ...
    <div className="space-y-8">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-2">
        <div>
          <div className="flex items-center gap-2 text-xs font-semibold text-slate-500 mb-1">
            ...
            <span className="text-slate-800">Cookie Management</span>
          </div>
        ...
        <div className="flex items-center gap-3">
          ...
          <button
            ...
            className="px-4 py-2.5 rounded-xl bg-slate-900 hover:bg-slate-800 text-white text-xs sm:text-sm font-semibold transition-all flex items-center gap-2 shadow-sm cursor-pointer"
          >
      ...
      <div className="p-6 rounded-3xl bg-white border border-[#EAE3D7] shadow-xs flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6">
        ...
        <div className="flex flex-wrap items-center gap-3 shrink-0">
          <button
            ...
            className="px-4 py-2.5 rounded-xl border border-slate-300 hover:bg-slate-50 text-slate-700 text-xs sm:text-sm font-semibold transition-colors flex items-center gap-2 cursor-pointer"
          >
          ...
          <button
            onClick={handleOpenPreferencesModal}
            className="px-4 py-2.5 rounded-xl bg-slate-900 hover:bg-slate-800 text-white text-xs sm:text-sm font-semibold transition-colors flex items-center gap-2 cursor-pointer shadow-xs"
          >
            <SlidersHorizontal className="w-4 h-4 text-amber-400" />
      ...
      <div className="bg-white rounded-2xl border border-[#EAE3D7] shadow-xs overflow-hidden">
        <div className="p-5 border-b border-slate-100 flex items-center justify-between">
          ...
          <span className="text-xs text-slate-400 font-mono">5 Active Trackers</span>
        </div>
            ...
            <tbody className="divide-y divide-slate-100 text-slate-600">
              {cookieRegister.map((cookie, index) => (
                <tr key={index} className="hover:bg-slate-50/80 transition-colors">
                  ...
                  <td className="p-4 whitespace-nowrap">{cookie.duration}</td>

                  <td className="p-4 whitespace-nowrap text-slate-500">{cookie.provider}</td>

                  <td className="p-4 max-w-sm text-xs leading-relaxed text-slate-700">
                    {cookie.purpose}
                  </td>
