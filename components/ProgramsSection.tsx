...
export default function ProgramsSection() {
  ...
  return (
    <section id="programs" className="relative py-14 sm:py-16 lg:py-20 bg-[#F5F0E8]/60 overflow-hidden">
        ...
        <AnimatePresence mode="wait">
          ...
          >
            <FloatingCard
              ...
              scaleOnHover={1.01}
              elevatedDepth={8}
              className="rounded-3xl bg-white border border-[#EAE3D7] p-6 sm:p-8 lg:p-10 shadow-lg hover:shadow-2xl relative overflow-hidden"
            >
            {/* Top Badge & Header */}
            <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-6 pb-6 border-b border-[#EAE3D7]">
              <div>
